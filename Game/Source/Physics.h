...
public:
	...
	Body(BodyType bodyType_, ColliderType colliderType_ = ColliderType::UNDEFINED, fPoint position_ = { 0.0f,0.0f }, SDL_Texture* texture_ = NULL, RectCollider* collider_ = NULL, uint mass_ = 1) // Constructor with body type and collider type
	{
		name = "noname";
		bodyType = bodyType_;
		position = position_;
...
public:
	...
	DynamicBody(fPoint position_, fPoint velocity_, fPoint gravity_, fPoint acceleration_, ColliderType colliderType_, SDL_Texture* texture_, RectCollider* collider_, uint mass_) :Body(BodyType::DYNAMIC_BODY, colliderType_, position_, texture_, collider_, mass_)
	{
		velocity = velocity_;
