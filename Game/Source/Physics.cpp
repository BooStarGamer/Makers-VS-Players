...
bool Physics::Update(float dt)
{
	...
	if (app->scene->GetCurrScene() == Scenes::PAUSE_MENU) Step(dt / 10000);
	else { Step(dt); }
...
Body* Physics::CreateBody(BodyType bodyType_, ColliderType colliderType_, fPoint position_, SDL_Texture* texture_, RectCollider* collider_, fPoint velocity_, fPoint gravity_, fPoint acceleration_, uint mass_)
{
